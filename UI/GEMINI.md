...
- `backend/` — Express API server (ioredis + PostgreSQL); see [`backend/GEMINI.md`](backend/GEMINI.md)
- `frontend/` — React dashboard; see [`frontend/GEMINI.md`](frontend/GEMINI.md)

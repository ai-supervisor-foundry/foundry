...
export class Migrations1771771098455 implements MigrationInterface {
  name = 'Migrations1771771098455';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "project_allowed_user" ("project_id" integer NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_aa4c9b61a5100f64748435bcd6f" PRIMARY KEY ("project_id", "user_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."project_access_type_enum" AS ENUM('all', 'restricted')`,
    );
    await queryRunner.query(
      `ALTER TABLE "project" ADD "access_type" "public"."project_access_type_enum" NOT NULL DEFAULT 'all'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "project" DROP COLUMN "access_type"`);
    await queryRunner.query(`DROP TYPE "public"."project_access_type_enum"`);
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "project_allowed_user"`);
    await queryRunner.query(
